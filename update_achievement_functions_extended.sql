-- Обновленная функция проверки достижений с поддержкой новых типов
-- Выполните этот скрипт в Supabase SQL Editor

-- Удаление существующей функции
DROP FUNCTION IF EXISTS check_and_award_achievements(INTEGER, BIGINT, TEXT, JSONB);

-- Обновленная функция для проверки и выдачи достижений
...
SELECT 'Функция проверки достижений обновлена с поддержкой новых типов!' as message;
