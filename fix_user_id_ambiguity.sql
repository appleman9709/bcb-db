-- Исправление неоднозначности user_id в функциях достижений
-- Этот скрипт исправляет все проблемы с неоднозначными ссылками на user_id
...
DROP FUNCTION IF EXISTS get_achievement_notifications(INTEGER, BIGINT, INTEGER);
...
-- Создаем исправленную функцию check_family_history_and_award_achievements
...
-- Создаем исправленную функцию get_achievement_notifications
...
SELECT 'Все функции достижений исправлены! Проблемы с неоднозначностью user_id устранены.' as message;
