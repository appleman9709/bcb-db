  ...
  return (
    <div className="tamagotchi-container relative">
      ...
      {/* Лоток с предметами */}
        ...
        backpackIntroMessage={backpackIntroMessage}
        lowOnDiapers={lowOnDiapers}
        lowOnFormula={lowOnFormula}
        inventoryTotals={inventoryTotals}
        displayPortionsText={displayPortionsText}
        portionSizeOunces={portionSizeOunces}
        portionSizeOuncesInput={portionSizeOuncesInput}
        onPortionSizeOuncesInputChange={setPortionSizeOuncesInput}
        handleApplyPortionSize={handleApplyPortionSize}
        portionSizeStatus={portionSizeStatus}
        portionSizeStatusClass={portionSizeStatusClass}
        restockDiapersInput={restockDiapersInput}
        restockGramsInput={restockGramsInput}
        setRestockDiapersInput={setRestockDiapersInput}
        setRestockGramsInput={setRestockGramsInput}
        handleRestockSubmit={handleRestockSubmit}
        restockPortionsPreviewText={restockPortionsPreviewText}
