...
export default function BottomNavigation({ activeTab, onTabChange }: BottomNavigationProps) {
  return (
    <div className="fixed bottom-4 left-4 right-4 bg-white/80 backdrop-blur-md border border-gray-200/50 px-4 py-3 pb-4 safe-area-pb iphone14-nav z-40 rounded-3xl shadow-lg">
