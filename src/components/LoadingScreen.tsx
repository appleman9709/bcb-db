const steps = [
  {
    title: "Обновляем ленту событий",
    description: "Синхронизируем последние кормления, пеленания и купания"
  },
  {
    title: "Проверяем напоминания",
    description: "Подготавливаем график и уведомления для вашей семьи"
  },
  {
    title: "Готовим советы дня",
    description: "Находим рекомендации, подходящие возрасту малыша"
  }
]
      ...
      <div className="relative w-full max-w-2xl overflow-hidden rounded-[2.5rem] border border-white/10 bg-gray-900/80 px-10 py-12 text-center shadow-[0_25px_60px_-15px_rgba(15,23,42,0.75)] backdrop-blur-xl">
        ...
        <div className="relative mt-8 flex flex-col items-center gap-4">
          ...
          <div className="space-y-1">
            ...
            <p className="text-base text-gray-300">Пока мы загружаем данные из базы, устройтесь поудобнее.</p>
          </div>
        </div>
        ...
        <div className="relative mt-10 text-sm text-gray-400">
          <span className="loading-dots">Загружаем персональные данные</span>
        </div>
      </div>
    </div>
  )
