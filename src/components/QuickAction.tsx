  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 flex flex-col items-center gap-2">
        <div className={`flex h-10 w-10 items-center justify-center rounded-xl text-lg text-white shadow-[0_8px_24px_-8px_rgba(79,70,229,0.6)] ring-1 ring-white/25 transition-transform duration-300 group-hover:scale-105 ${getIconGradient(variant)}`}>
          {icon}
        </div>
