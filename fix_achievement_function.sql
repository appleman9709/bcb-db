-- Исправление функции check_and_award_achievements
-- Эта версия исправляет проблемы с логикой проверки достижений
...
BEGIN
    ...
    LOOP
        ...
        -- Проверяем критерии достижения по типу критерия, а не по типу активности
...
SELECT 'Функция check_and_award_achievements исправлена! Теперь достижения должны работать корректно.' as message;
