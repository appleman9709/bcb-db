-- Быстрое исправление функции check_and_award_achievements
-- Выполните этот скрипт для исправления ошибки с типом возврата

-- Удаляем существующую функцию
DROP FUNCTION IF EXISTS check_and_award_achievements(INTEGER, BIGINT, TEXT, JSONB);

-- Создаем новую функцию с правильным типом возврата
...
\echo 'Функция check_and_award_achievements успешно обновлена!'
